...
local L = (function(tbl, defaultLocale)
	...
	["ptBR"] = {
		...
		["Cooldown Manager Frames"] = "Frames do Gerenciador de Recargas",
		["Control Essential Cooldown Viewer"] = "Controlar Visualizador de Cooldowns Essenciais",
		["Control Essential Cooldown Viewer tooltip"] = "Registra o frame EssentialCooldownViewer para controle de visibilidade por cenário.",
		["Control Utility Cooldown Viewer"] = "Controlar Visualizador de Cooldowns Utilitários",
		["Control Utility Cooldown Viewer tooltip"] = "Registra o frame UtilityCooldownViewer para controle de visibilidade por cenário.",
	...
	["enUS"] = {
		...
		["Cooldown Manager Frames"] = "Cooldown Manager Frames",
		["Control Essential Cooldown Viewer"] = "Control Essential Cooldown Viewer",
		["Control Essential Cooldown Viewer tooltip"] = "Registers the EssentialCooldownViewer frame for per-scenario visibility control.",
		["Control Utility Cooldown Viewer"] = "Control Utility Cooldown Viewer",
		["Control Utility Cooldown Viewer tooltip"] = "Registers the UtilityCooldownViewer frame for per-scenario visibility control.",
		["Evoker"] = "Evoker",
