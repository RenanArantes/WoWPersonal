...
local L = (function(tbl, defaultLocale)
	...
	["ptBR"] = {
		...
		["Clip Advice"] = "Conselho de Clip (Disintegrate)",
		["Disintegrate Clip Advice"] = "Conselho de Clip do Desintegrar",
		["Show clip advice indicator"] = "Mostrar indicador de clip",
		["Show clip advice indicator tooltip"] = "Mostra uma barra abaixo da castbar durante o Disintegrate: verde quando há essência suficiente (3+) para clippar e castar o próximo Disintegrate, vermelho quando não há ou durante Mass Disintegrate (que nunca deve ser clipado).",
	},
	["enUS"] = {
		[addonName] = "WoWPersonal",
		...
		["Clip Advice"] = "Clip Advice (Disintegrate)",
		["Disintegrate Clip Advice"] = "Disintegrate Clip Advice",
		["Show clip advice indicator"] = "Show clip advice indicator",
		["Show clip advice indicator tooltip"] = "Shows a bar below the cast bar during Disintegrate: green when you have enough essence (3+) to clip and cast the next Disintegrate, red when you don't or during Mass Disintegrate (which should never be clipped).",
	},
	["esES"] = {},
	["deDE"] = {},
	["frFR"] = {},
